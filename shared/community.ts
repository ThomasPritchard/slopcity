...
export const COMMUNITY_LIMITS = { inputBytes:4*1024*1024, pixels:12_000_000, outputBytes:1024*1024, pendingPerGuest:5, pendingGlobal:75, retained:200, dailyPerGuest:10, dailyGlobal:100, slideMs:20_000 } as const;
