...
export interface GiftReceipt { requestId:string; targetId:string; amount:number; wallet:WalletState; giftingAllowance:number; replayed:boolean; reversed?:boolean }
