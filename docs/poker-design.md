...
- Blinds: 5 / 10 chips. Buy in between hands for 200–1,000 wallet credits, in steps of 100; default 500. One credit becomes one table chip. The cap applies to entry, not winnings. No mid-hand top-ups.
...
- Twenty seconds per turn. Expiry checks when free and folds when facing a bet. The first hand starts after an eight-second admission window once two players are ready; subsequent hands have an eight-second result interval. All-in runout deals remaining streets at 1.2-second intervals.
- Closing the panel keeps the seat. **Leave table** marks departure immediately and folds on the next legal turn. All-in hands and hands whose betting is already complete stay eligible. Remaining chips return after settlement; leaving between hands returns the stack immediately.
