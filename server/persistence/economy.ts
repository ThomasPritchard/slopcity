...
export class EconomyRepository {
 ...
 async initialise() {
  await this.transaction(async c=>{
   ...
   if(!versions.rows.some(r=>r.version===1)||versions.rows.some(r=>r.version!==1&&r.version!==2&&r.version!==3&&r.version!==4&&r.version!==5&&r.version!==6&&r.version!==7&&r.version!==8&&r.version!==9))throw new Error('Unsupported economy schema');
